...
<div class="container-fluid bg-dark">
    ...
    <div class="container-fluid mt-4 bg-gray">
    <h1 class="m-0 text-capitalize text-center" style="margin-top:40px;"><span class="text-dark"></span><span>Dogs</span><span > For</span<span > Adoption</span></h1>
...
<div class='container-fluid'>
         ...
         include 'config.php';
            if (isset($_SESSION['username']))              
                ...
                //  $allData = mysqli_query($conn,"SELECT * FROM `admin_upload` WHERE approved='approved' AND Pet_Name='cat'");
                 $allData = mysqli_query($conn,"SELECT * FROM `admin_upload` WHERE p_type='dog' ");
             ...
             //   row akare data ashbe
                ...
                echo"
                    ...
                    <div class='menu-header bg-gray text-center p-3'>
                        <h1 class='m-0 text-capitalize'><span class='text-dark'></span><span class='text-primary'>Dogs</span><span > For</span<span > Adoption</span></h1>
                    </div>";
       ...
       echo"
                <div class='m-5 d-inline-block border border-1 border-dark'>
                        ...
                        <h5 class='text-center text-capitalize'>Pet Gender:$row[p_gender]</h5>
