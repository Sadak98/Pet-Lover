...
$imageLocation = $f_image['tmp_name'];
$imageName = $f_image['name'];
...
// }
// else{
    $insert_query = "INSERT INTO `fooddetails`(`f_name`, `f_price`, `f_type`, `f_image`) VALUES ('$f_name','$f_price','$f_for','$image_des')";
