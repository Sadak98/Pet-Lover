...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
                <form action="../fdupAction.php"  method="post" enctype="multipart/form-data">
                    <div class="mb-3 text-center" style="color:orange">
                        <h3>Food Details</h3>
                            ...
                            <div class="mb-3">
                                Price :
                                <input type="text" class="form-control" name="f_price">
                            </div>
<!--                         
                            ...
                            Food For :
                            <select name="f_for" class="form-control">
...
<!--                         
                    ...
                    <button type="submit" class="btn btn-primary col-12" name="login">Upload</button>
