...
<h1 class="mb-5 text-center bg-gary my-5 ">Pet Details</h1>
   <thead>
       <tr>
          <th scope="col">ID</th>
        ...
        <?php
         include 'config.php';
         $allData = mysqli_query($conn,"SELECT * FROM `admin_upload`");
        ...
        //   row akare data ashbe
         while($row = mysqli_fetch_array($allData)){
           echo"<tr>
                   ...
                   <td><a class='btn btn-danger' href='p_delete.php? id=$row[id]'>Delete</a></td>
